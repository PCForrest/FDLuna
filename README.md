...
DDSTextureLoader is now used to load all textures.

All BMP (bitmap) textures have been replaced with DDS (Direct Draw Surface) equivalents.

It is no longer necessary to create texture arrays in code; DDS supports texture arrays and texture cubes.
